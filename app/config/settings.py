...
class Settings(BaseSettings):
    ...
    llm_script_editor_enabled: bool = Field(default=True, alias="LLM_SCRIPT_EDITOR_ENABLED")
    llm_chunked_script_enabled: bool = Field(default=True, alias="LLM_CHUNKED_SCRIPT_ENABLED")
    llm_chunked_model: str = Field(default="qwen2.5:3b-instruct", alias="LLM_CHUNKED_MODEL")
    llm_script_chunk_size: int = Field(default=3, alias="LLM_SCRIPT_CHUNK_SIZE")
    llm_request_timeout_seconds: float = Field(default=360.0, alias="LLM_REQUEST_TIMEOUT_SECONDS")
